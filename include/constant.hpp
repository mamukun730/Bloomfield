...
const static bool ENABLE_FULLGOAL				= false;
...
//const static float GAIN_P_ENCODER				= 1.381818182;
//const static float GAIN_I_ENCODER				= 0.021212121;
//const static float GAIN_D_ENCODER				= 0.654545455;

// Gyro
//const static float GYRO_RESOLUTION			= (1.0 / 16.4);		// deg/s
const static float GYRO_RESOLUTION				= (1.0 / 14.6866);		// deg/s
const static uint16_t GYRO_REFERENCE_SAMPLE		= 2000;
...
const static uint16_t SENSOR_TARGET_L			= 200;				// 壁制御目標
const static uint16_t SENSOR_TARGET_R			= 380;

const static uint16_t SENSOR_CTRL_THRESHOLD_L	= 100;				// 壁制御閾値
const static uint16_t SENSOR_CTRL_THRESHOLD_R	= 190;

const static uint16_t SENSOR_DIFF_THRESHOLD		= 30;

const static uint16_t SENSOR_WALL_EXIST_L		= 110;				// 壁有無閾値
const static uint16_t SENSOR_WALL_EXIST_F		= 120;
...
const static uint8_t RSPI_DATA_GYRO_PWR_MGMT2		= 0x3E;
